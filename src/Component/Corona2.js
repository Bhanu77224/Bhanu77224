...
export default function Corona2() {
    useEffect(() => {
        getdata();
    }, []);
    ...
    const getdata = async () => {
        await axios.get('https://timenews.co.in/wp-json/wp/v2/posts?categories=833&page=2').then((response) => {
        ...
        <>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    <li class="page-item">
                        <Link to="/corona2" className="page-link">
                            2
                        </Link>
                    </li>
                    <li class="page-item">
                        <Link to="/corona3" className="page-link">
                            3
                        </Link>
                    </li>
                </ul>
