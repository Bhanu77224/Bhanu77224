...
export default function Ahmedabad() {
    ...
    const getdata = async () => {
        await axios.get('https://timenews.co.in/wp-json/wp/v2/posts?categories=24&page=2').then((response) => {
    ...
    return (
        <>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item">
                        <Link to="/world" className="page-link">
                            1
                        </Link>
                    </li>
                    <li class="page-item">
                        <Link to="/world2" className="page-link">
                            2
                        </Link>
                    </li>
                    <li class="page-item">
                        <Link to="/world3" className="page-link">
                            3
                        </Link>
                    </li>
                </ul>
